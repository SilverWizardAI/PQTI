"""
PyQt6 Transport Layer - Unix Socket IPC.

Handles low-level communication with PyQt6 applications via Unix domain sockets.
This module is PyQt6-specific and uses QLocalSocket protocol.
"""
...
class QtTransport:
    """
    Transport layer for PyQt6 IPC communication.

    Uses Unix domain sockets to communicate with PyQt6 applications
    that have QLocalServer instrumentation enabled.
    """
